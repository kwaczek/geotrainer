...
export const initQuizSession = async (req: Request, res: Response) => {
  try {
    ...
    // Validate quiz type
    if (!type || ![QuizType.FLAGS, QuizType.CAPITALS, QuizType.BOLLARDS, QuizType.LICENSEPLATES, QuizType.ROADSIGNS, QuizType.LANGUAGES, QuizType.CARS].includes(type.toLowerCase() as QuizType)) {
