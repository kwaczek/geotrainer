...
const QuizRouter: React.FC = () => {
  ...
  const isValidQuizType = id && ['capitals', 'flags', 'bollards', 'licenseplates', 'roadsigns', 'languages', 'cars', 'poles', 'domains', 'currencies', 'phoneprefixes'].includes(id);
...
const QuizSessionRouter: React.FC = () => {
  ...
  // Validate that the quiz type is supported
  const isValidQuizType = type && ['capitals', 'flags', 'bollards', 'licenseplates', 'roadsigns', 'languages', 'cars', 'poles', 'domains', 'currencies', 'phoneprefixes'].includes(type);
