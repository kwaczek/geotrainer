...
const Header: React.FC = () => {
  ...
  const toggleLearnMenu = () => {
    setIsLearnMenuOpen(!isLearnMenuOpen);
    setIsSourcesMenuOpen(false); // Close other menu
  };

  const toggleSourcesMenu = () => {
    setIsSourcesMenuOpen(!isSourcesMenuOpen);
        ...
        <nav>
          <ul className="flex items-center space-x-6">
            <li className="relative group">
              <span className="hover:text-blue-100 transition-colors cursor-pointer flex items-center text-sm" onClick={toggleLearnMenu}>
                Learn
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </span>
              <div className={`absolute ${isLearnMenuOpen ? 'block' : 'hidden'} group-hover:block bg-blue-600 p-2 rounded shadow-lg left-0 w-40 z-10`}>
            ...
            {/* Sources Dropdown */}
            <li className="relative group">
              <span className="hover:text-blue-100 transition-colors cursor-pointer flex items-center text-sm" onClick={toggleSourcesMenu}>
                Sources
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </span>
              <div className={`absolute ${isSourcesMenuOpen ? 'block' : 'hidden'} group-hover:block bg-blue-600 p-3 rounded shadow-lg left-0 w-64 z-10`}>
                ...
                {/* Separator and additional thanks */}
