          ...
          <div className="p-3 border rounded bg-gray-50">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={selectedTypes.includes('street')}
                  onChange={(e) => {
                    if (e.target.checked) {
                      setSelectedTypes([...selectedTypes, 'street']);
                    } else {
                      setSelectedTypes(selectedTypes.filter(t => t !== 'street'));
                    }
                  }}
                  className="form-checkbox"
                />
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={selectedTypes.includes('town')}
                  onChange={(e) => {
                    if (e.target.checked) {
                      setSelectedTypes([...selectedTypes, 'town']);
                    } else {
                      setSelectedTypes(selectedTypes.filter(t => t !== 'town'));
                    }
                  }}
                  className="form-checkbox"
                />
